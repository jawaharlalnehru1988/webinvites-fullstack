...
const ScratchCardComponent = (props, ref) => {
	...
	const revealAll = useCallback((options) => {
		if (!isReady) return;
	...
	const canvasStyle = useMemo(() => buildCanvasStyle(width, height, isReady, enabled), [
		width,
		height,
		isReady,
		enabled
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			scratchRegion && coverBackground && /* @__PURE__ */ jsx("canvas", {
				ref: bgCanvasRef,
...
const ScratchCard = forwardRef(ScratchCardComponent);
...
//#endregion
export { Brushes, Covers, Regions, ScratchCard as default };
